...
An example with values of 0.5 for both label scalings:
```{r}
blastResults <- getBlastResults("../data-raw/exampleQueryFasta.fasta","../data-raw/exampleDatabase.fasta",maxSequencesReturned=5, dbType="nucl", userFastaType="prot")
```
